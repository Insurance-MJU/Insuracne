...
public class Contract implements Serializable {
    ...
    public static List<Contract> findAll() { return new ArrayList<>(STORE); }
    public static Contract findByPolicyNo(String policyNo) {
        return STORE.stream().filter(c -> c.policyNo.equals(policyNo)).findFirst().orElse(null);
    }
    ...
    public void save() {
        STORE.removeIf(c -> c.contractId.equals(this.contractId));
        STORE.add(this);
        FileStore.save("contracts.dat", STORE);
    }
